...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference("Medication.count") do
      post medications_url, params: { medication: { amount_left: @medication.amount_left, amount_taken: @medication.amount_taken, dose: @medication.dose, last_picked_up: @medication.last_picked_up, name: @medication.name } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { amount_left: @medication.amount_left, amount_taken: @medication.amount_taken, dose: @medication.dose, last_picked_up: @medication.last_picked_up, name: @medication.name } }
